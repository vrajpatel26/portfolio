...
const Contact = () => {
    return (
        <section
            id="contact"
            className="bg-[#12122D] scroll-mt-20 border-t border-[#2A2950]"
        >
            {/* ================= TOP SECTION ================= */}
            ...
            <div className="max-w-5xl mx-auto px-5 sm:px-8 py-20 text-center">
                ...
                <p className="mt-8 text-[#A7A7C7] text-lg leading-9 max-w-3xl mx-auto">
                    ...
                    scalable web applications and would
                    love to contribute to impactful products.
                ...
                <a
                    href="mailto:vraj.261604@gmail.com"
